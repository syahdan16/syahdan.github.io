...
<div class="row gy-2 gx-0 mb-3">
  ...
  <div class="col-4">
    <a href="<?php echo $alamat_website.'profil_saya'; ?>" class="d-flex justify-content-center align-items-center text-uppercase text-white btn-utama mx-3 p-2">
...
<form method="post">
  <div class="row gx-0 gy-3 justify-content-center align-items-center mb-3">
    ...
    <div class="col-10 px-4">
      ...
      <button type="submit" name="profil_saya" class="d-block ms-auto btn btn-utama text-uppercase rounded-0 my-3">Simpan Data Profil Saya</button>
    </div>
  </div>
</form>