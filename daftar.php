  ...
  <div class="row gy-3 gx-0 justify-content-center align-items-center my-5">
    ...
    <div class="col-10 px-4">
      ...
      <div class="text-center">
        ...
        <a href="#" class="text-decoration-none text-uppercase d-block mt-2" style="color: #FF0000;">Syarat & Ketentuan</a>
      </div>
      <button type="submit" name="daftar" class="d-block ms-auto btn btn-utama text-uppercase rounded-0">Daftar</button>
    </div>
  </div>
</form>