<div class="row gy-2 gx-0 mb-3">
  <div class="col-4">
    <a href="<?php echo $alamat_website.'akun_saya'; ?>" class="d-flex justify-content-center align-items-center text-uppercase text-white btn-utama mx-3 p-2">
...
<div class="row gx-0 gy-3 justify-content-center align-items-center mb-3">
    ...
    <div class="col-10 px-4" style="font-size: 16px;">
      <div>Nama Lengkap : <?php echo $nama_lengkap_akun_masuk; ?></div>
      <div>Email : <?php echo $email_akun_masuk; ?></div>
      <div>Nama Pengguna : <?php echo $nama_pengguna_akun_masuk; ?></div>
    </div>
    <div class="col-10 text-center btn-utama p-2">
      <span style="font-size: 18px;">Informasi Akun</span>
    </div>
