  ...
  <body>
      ...
      <div class="main-content">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                Versi : 1.0 - <?php echo date("Y").' &copy; <a href="'.$alamat_website.'">'.$isi1_judul_website.'</a>'; ?>
              </div>
              <div class="col-sm-6">
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo $alamat_website.'keluar.php'; ?>" class="d-flex justify-content-center align-items-center btn btn-danger">
    ...
    <?php
          if (isset($_POST['tambah_data'])) {
            ...
            $format =  array('png', 'PNG', 'jpg', 'JPG', 'jpeg', 'JPEG');
    ...
    <?php
          if (isset($_POST['tambah_data'])) {
            $kategori_rekening_admin = $_POST['kategori_rekening_admin'];
            $id_rekening_rekening_admin = $_POST['id_rekening_rekening_admin'];
            $nama_rekening_admin = $_POST['nama_rekening_admin'];
            $nomor_rekening_admin = $_POST['nomor_rekening_admin'];
            $tambah_data = mysqli_query($koneksi, "INSERT INTO rekening_admin (kategori_rekening_admin, id_rekening_rekening_admin, nama_rekening_admin, nomor_rekening_admin) VALUES ('$kategori_rekening_admin', '$id_rekening_rekening_admin', '$nama_rekening_admin', '$nomor_rekening_admin')");
            if ($tambah_data) {
    ?>
    <script>
      $(document).ready(function () {
    ...
    <?php
            ...
            $nama_rekening_admin = $_POST['nama_rekening_admin'];
            $nomor_rekening_admin = $_POST['nomor_rekening_admin'];
            $ubah_data = mysqli_query($koneksi, "UPDATE rekening_admin SET kategori_rekening_admin = '$kategori_rekening_admin', id_rekening_rekening_admin = '$id_rekening_rekening_admin', nama_rekening_admin = '$nama_rekening_admin', nomor_rekening_admin = '$nomor_rekening_admin' WHERE id_rekening_admin = '$id_rekening_admin'");
            if ($ubah_data) {
    ?>
    <script>
      $(document).ready(function () {
    ...
    <?php
            ...
            $ubah_data = mysqli_query($koneksi, "UPDATE pengaturan SET isi1_pengaturan = '$isi1_pengaturan' WHERE nama_pengaturan = 'marquee_pengumuman'");
            if ($ubah_data) {
    ?>
    <script>
      $(document).ready(function () {
    ...
    <?php
            ...
            $format =  array('png', 'PNG', 'jpg', 'JPG', 'jpeg', 'JPEG', 'ico', 'ICO');
            $extensi = pathinfo($nama_file, PATHINFO_EXTENSION);
            if (!in_array($extensi, $format)) {
    ?>
    <script>
    ...
    <?php
            ...
            $isi2_pengaturan = $_POST['link_gambar_popup_pengaturan'];
            $isi3_pengaturan = $_POST['detail_popup_pengaturan'];
            $random = rand(1000000000, 9999999999);
