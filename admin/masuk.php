            ...
            <div class="col-lg-12">
              <div class="text-center">
                <p class="mb-0 text-muted">
                  <?php echo date("Y"); ?> &copy; <a href="<?php echo $alamat_website; ?>"><?php echo $isi1_judul_website; ?></a> - Dikembangkan oleh : <a href="https://instagram.com/id.masgi" target="_blank">Masgi</a> - Versi : 1.0
                </p>
              </div>
            </div>
          </div>
