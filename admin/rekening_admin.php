                ...
                <tbody>
                  <?php
                    ...
                    while ($data_rekening_admin = mysqli_fetch_array($rekening_admin)) {
                      ...
                      $kategori_rekening_admin = $data_rekening_admin['kategori_rekening_admin'];
                      ...
                      $rekening = mysqli_query($koneksi, "SELECT * FROM rekening WHERE id_rekening = '$id_rekening_rekening_admin'");
                  ...
                  <tr>
                    <td>
                      <?php
                        if ($kategori_rekening_admin == "bank") {
                          echo 'Bank';
                        } else if ($kategori_rekening_admin == "emoney") {
                          echo 'E-Money';
                        } else if ($kategori_rekening_admin == "pulsa") {
                          echo 'Pulsa';
                        }
                      ?>
                    </td>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="mb-2">
                              ...
                              <select class="form-select" name="kategori_rekening_admin">
                                <?php
                                  if ($kategori_rekening_admin == "bank") {
                                    echo '
                            ...
                            <div class="mb-2">
                              ...
                              <select class="form-select" name="id_rekening_rekening_admin" required>
                                <option value="<?php echo $id_rekening_rekening_admin; ?>"><?php echo $jenis_rekening; ?></option>
                                <?php
                                  $rekening = mysqli_query($koneksi, "SELECT * FROM rekening WHERE NOT id_rekening = '$id_rekening_rekening_admin'");
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-2">
            <label class="form-label">Kategori</label>
            <select class="form-select" name="kategori_rekening_admin" required>
