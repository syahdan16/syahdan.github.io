! function() {
  ...
  }), sessionStorage.setItem("defaultAttribute", JSON.stringify(a)), z(a), (i = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && i.click()), h(), o = document.getElementById("search-close-options"), om = document.getElementById("search-close-options-mobile"), s = document.getElementById("search-dropdown"), sm = document.getElementById("search-dropdown-mobile"), (d = document.getElementById("search-options"), dm = document.getElementById("search-options-mobile")) && (d.addEventListener("focus", function() {
  ...
  }), dm.addEventListener("focus", function() {
    0 < dm.value.length ? (s.classList.add("show"), om.classList.remove("d-none")) : (sm.classList.remove("show"), om.classList.add("d-none"))
  }), dm.addEventListener("keyup", function(e) {
    var n, t;
    0 < dm.value.length ? (sm.classList.add("show"), om.classList.remove("d-none"), n = dm.value.toLowerCase(), t = document.getElementsByClassName("notify-item"), Array.from(t).forEach(function(e) {
      var t, a, o = "";
      e.querySelector("h6") ? (t = e.getElementsByTagName("span")[0].innerText.toLowerCase(), o = (a = e.querySelector("h6").innerText.toLowerCase()).includes(n) ? a : t) : e.getElementsByTagName("span") && (o = e.getElementsByTagName("span")[0].innerText.toLowerCase()), o && (e.style.display = o.includes(n) ? "block" : "none")
    })) : (sm.classList.remove("show"), om.classList.add("d-none"))
  }), om.addEventListener("click", function() {
    dm.value = "", sm.classList.remove("show"), om.classList.add("d-none")
  }), document.body.addEventListener("click", function(e) {
    "search-options-mobile" !== e.target.getAttribute("id") && (sm.classList.remove("show"), om.classList.add("d-none"))
  })), t = document.getElementById("search-close-options"), tm = document.getElementById("search-close-options-mobile"), n = document.getElementById("search-dropdown-reponsive"), nm = document.getElementById("search-dropdown-reponsive-mobile"), e = document.getElementById("search-options-reponsive"), em = document.getElementById("search-options-reponsive-mobile"), t && n && e && (e.addEventListener("focus", function() {
  ...
  })), tm && nm && em && (em.addEventListener("focus", function() {
    0 < em.value.length ? (nm.classList.add("show"), tm.classList.remove("d-none")) : (nm.classList.remove("show"), tm.classList.add("d-none"))
  }), em.addEventListener("keyup", function() {
    0 < em.value.length ? (nm.classList.add("show"), tm.classList.remove("d-none")) : (nm.classList.remove("show"), tm.classList.add("d-none"))
  }), tm.addEventListener("click", function() {
    em.value = "", nm.classList.remove("show"), tm.classList.add("d-none")
  }), document.body.addEventListener("click", function(e) {
    "search-options-mobile" !== e.target.getAttribute("id") && (nm.classList.remove("show"), tm.classList.add("d-none"))
  ...
  }), O(), D(), S(), [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(e) {
  ...
  }), f(), x(), window.addEventListener("resize", function() {
