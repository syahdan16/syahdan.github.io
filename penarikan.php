...
<form method="post">
  <div class="row gy-2 gx-0">
    ...
    <div class="col-6">
      <a href="<?php echo $alamat_website.'penarikan'; ?>" class="d-flex justify-content-center align-items-center text-uppercase text-white btn-utama mx-3 p-2">
  ...
  <div class="row gy-2 gx-0 d-flex justify-content-center align-items-center mt-5">
    ...
    <div class="col-10">
      <button type="submit" name="tarik" class="d-block ms-auto btn btn-utama text-uppercase rounded-0 w-100 py-3" style="font-size: 12px;">Tarik</button>
    </div>
  </div>
</form>