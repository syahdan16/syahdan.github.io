...
<form method="post">
  ...
  <div class="row gx-0 gy-3 justify-content-center align-items-center mb-3">
    ...
    <div class="col-10 px-4">
      <button type="submit" name="tambah_rekening" class="d-block ms-auto btn btn-utama rounded-0 text-uppercase py-3" style="font-size: 12px;">Tambah Akun</button>
    </div>
  </div>
  <div class="row gx-0 gy-3 justify-content-center align-items-center mb-3">
    <div class="col-10 text-center btn-utama p-2">
    ...
    ?>
    <div class="col-10 px-4">
      <div class="btn-utama p-2" style="font-size: 16px;">
    ...
    ?>
    <div class="col-10 px-4">
      <div class="btn-utama text-center p-2" style="font-size: 16px;">
        Tidak ada data.
      </div>
    </div>
    <?php
